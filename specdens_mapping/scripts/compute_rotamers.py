...
def parse():
    ...
    return args.traj, args.top, args.trj_idx, args.out, args.stride
...
def main():
    trajfile, top, trj_idx, outdir, stride = parse()
    ...
    for k,f in enumerate(funcs):
        ...
        save_hist( residues, outdir + "/" + "residues_" + outs[k] + "_" + str(trj_idx) )
        save_hist( angm, outdir + "/" + outs[k] + "_" + str(trj_idx) )
